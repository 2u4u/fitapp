...
* Просмотр марафона
  ...
  * ~Переключение между марафонами - загрузка или очищение старого значения~
...
* Редактирование марафона
  * Если меняет название, то давать ссылку на новый марафон, тк он в этот момент уже другой

* Включить проверку сессии в routes/api/users.js на боевом сервере изменить на 3600
